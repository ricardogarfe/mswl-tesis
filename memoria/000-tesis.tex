...
\bibitem{BOE01} Boehm, B. 1988. \textit{A Spiral Model of Software Development and Enhancement}. IEEE Computer. Mayo, 1988.

\bibitem{RBJ01} Jacobson, I., Booch, G. and Rumbaugh, J. 1999. \textit{The Unified Software Development Process}. AW.

\bibitem{featurebranch} Fowler, Martin. \textit{Feature Branch}. http://martinfowler.com/bliki/FeatureBranch.html, September 2009.

\bibitem{boring-literature} Kaj Sand-Jensen, \textit{How to write consistently boring scientific literature}, \url{http://onlinelibrary.wiley.com/doi/10.1111/j.0030-1299.2007.15674.x/full}
...
\bibitem{gtd} David Allen, \textit{Getting Things Done}, The Art of Stress-Free Productivity \url{http://www.davidco.com/about-gtd}
...
\bibitem{correo-gestor-tareas} Jero Sánchez, \textit{4 razones para no usar el correo como organizador de tareas}, \url{http://elgachupas.com/4-razones-para-no-usar-el-correo-como-organizador-de-tareas/}
...
\include{./apendice-puppet}

% Instalación SidelabCode Stack
\include{./apendice-instalacion-scstack}
